...
class Chessboard:
    def __init__(self):
        ...
        self.fields: list[str] = [str(letter) + str(number) for number, letter in
                             list(itertools.product(self.numbers, self.letters))]

    def int_Touple_To_Chess_PositionStr(self, x_y_position: tuple[int, int]) -> str:
